...
/*
This function Check if an item is in a list of favorites using itemId
*/
...
/*
This function return truncated string greater then 50
We use this function further in showMealList function to limit the detail of meals in 50 words
*/
...
/*
 ...
 we will use this function in showMealDetails to search the meal items using their first letter
*/
...
showFavMealList - The function that is called when the toggle button is clicked. It populates the fav element with the list of favorite meals.
...
value - The value to append to the URL for filtering the results
then it returns promise that resolves to the JSON data of the meals
 */
...
The id of the meal to be added or removed.
...
The itemId  of the meal to show details for
The search input used to fetch the related meals
 */
...
This returns html which is used to show the favourite meals.
If there is no favourite meal then it will show "Add your favorite meal here"
*/
async function showFavMealList() {
    ...
    if (favList.length == 0) {
        ...
        Add your favorite meal here</h1> </div>`
    } else {
